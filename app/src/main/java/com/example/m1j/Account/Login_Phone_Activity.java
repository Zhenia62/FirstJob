...
//**********************Класс не является обходимым, можно удалить на стадии релиза**********************
public class Login_Phone_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login__phone_2);
        ...
        verificationCallbacks =
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        ...
                        Toast.makeText(Login_Phone_Activity.this, "Enter Correct Number.", Toast.LENGTH_SHORT).show();
                    ...
                    public void onCodeSent(String verificationId, PhoneAuthProvider.ForceResendingToken token) {
                        ...
                        iosDialog.cancel();
                        viewFlipper.setInAnimation(Login_Phone_Activity.this, R.anim.in_from_right);
                        viewFlipper.setOutAnimation(Login_Phone_Activity.this, R.anim.out_to_left);
    ...
    public void Goback(View view) {
        viewFlipper.setInAnimation(Login_Phone_Activity.this, R.anim.in_from_left);
        viewFlipper.setOutAnimation(Login_Phone_Activity.this, R.anim.out_to_right);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(code.equals("200")){
                                ...
                                Intent intent=new Intent(Login_Phone_Activity.this, Get_User_Info.class);
