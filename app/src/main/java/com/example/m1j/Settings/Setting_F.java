...
public class Setting_F extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // при нажатии кнопки выхода из системы он удалит сеанс пользователя и перейдет на экран входа в систему
    ...
    // ниже два метода используется получить фотографии пользователей и о тексте с нашего сервера
