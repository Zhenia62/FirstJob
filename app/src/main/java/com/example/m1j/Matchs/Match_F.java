package com.example.m1j.Matchs;
...
//это фрагмент, которое отображается, когда соискатель и работодатель "нашли друг друга"
//Эта важная деталь, которая не вышла в ствет. А значит, она не основная, но комментарии я все равно оставлю
...
public class Match_F extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(bundle!=null){
            ...
            // получите пользовательские данные из предыдущего view
    ...
    // откройте фрагмента чата и передача своего идентификатора и идентификатора другого человека, с котором
    //мы хотим пообщаться
    ...
    // когда этот "скрин" откроется, он отправит уведомление другому пользователю (Соис.\Работодат.)
