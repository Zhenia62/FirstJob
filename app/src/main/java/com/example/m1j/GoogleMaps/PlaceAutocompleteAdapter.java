...
public class PlaceAutocompleteAdapter extends RecyclerView.Adapter<PlaceAutocompleteAdapter.PlaceViewHolder> implements Filterable {
    ...
    /**
     * Устанавливает границы для всех последующих запросов.
     */
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    //Получить результаты автозаполнения.
                    mResultList = autocomplete(constraint.toString());

                    //Назначение данных результатами фильтрации
    ...
    private ArrayList<PlaceAutocomplete> autocomplete(String input) {
        ...
        try {
           ...
           // sb.append("?key=" + mContext.getResources().getString(R.string.google_api_debug));
            ...
            // Загрузите результаты в StringBuilder
            int read;
        ...
        try {
            // Создайте иерархию объектов JSON из результатов
            ...
            // Извлеките описания мест из результатов
    ...
    /**
     * Удерживаем результаты автозаполнения для мест гео данных через API.
     */
