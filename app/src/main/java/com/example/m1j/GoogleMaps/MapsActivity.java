...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    // Точка входа в проводник расположения.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Построение a PlaceDetectionClient.
        mPlaceDetectionClient = Places.getPlaceDetectionClient(this, null);

        // Построение a FusedLocationProviderClient.
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (mGoogleMap != null) {
            ...
            if (ActivityCompat.checkSelfPermission(getApplicationContext()
                ...
                // TODO: рассмотреть возможность вызова
                //    ActivityCompat#requestPermissions
                // здесь, чтобы запросить отсутствующие разрешения, а затем переопределить
                // public void onRequestPermissionsResult (int requestCode, String[] permissions,
                // int[] grantResults)
                // для обработки случая, когда пользователь предоставляет разрешение. Смотрите документацию.
                // для ActivityCompat#requestPermissions для получения более подробной информации.
                return;
            }
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            // Установить положение камеры на карте в соответствии с текущим местоположением устройства.
    ...
    private void getLocationPermission() {
        /*
         * Запрос разрешения местоположения, так что мы можем получить местоположение
         * устройства. Результат запроса разрешения обрабатывается обратным вызовом, он описан в
