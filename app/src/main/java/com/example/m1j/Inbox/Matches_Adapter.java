...
public class Matches_Adapter extends RecyclerView.Adapter<Matches_Adapter.CustomViewHolder > implements Filterable {
    ...
    public Matches_Adapter(Context context, ArrayList<Match_Get_Set> user_dataList, Matches_Adapter.OnItemClickListener listener, Matches_Adapter.OnLongItemClickListener longlistener) {
        ...
        // получить сегодня как целое число, чтобы принять решение дата чата сегодня или вчера
    ...
    // этот метод изменит дату на "сегодня", "вчера"
    public String ChangeDate(String date){
        //текущая дата в миллисекундах
        long currenttime= System.currentTimeMillis();

        //дата базы данных в миллисекундах
    ...
    // эта функция будет фильтровать результат
    @Override
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (Match_Get_Set row : inbox_dataList) {
                        ...
                        // условие соответствия имени. это может отличаться в зависимости от ваших требований
                        // здесь мы ищем совпадение имени или номера телефона
